      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="card-surface">
          ...
          <Toggle
            ...
            help="When enabled, Donna will automatically remember details from your phone calls — like who you spoke with and what was discussed — so you don’t have to log them manually."
          />
          <Toggle
            label="Auto-log Tasks"
            value={prefs.autoLogTasks}
            onChange={(v) => updatePref("autoLogTasks", v)}
            help="When this is on, tasks you assign or complete (in supported tools) will be remembered automatically."
          />
          <SelectField
            ...
            help={
              <>
                Controls how much Donna adapts based on your preferences and
                behavior.
                <br />
                <br />
                <strong>Low:</strong> Limited learning
                <br />
                <strong>Medium:</strong> Learns contextually
                <br />
                <strong>High:</strong> Full proactive memory + pattern awareness
              </>
            }
          />
          ...
          <SelectField
            ...
            help="GPT-3.5 is faster and cheaper. GPT-4 is more accurate and better at complex tasks."
          />
          ...
          <InputField
            ...
            help="This is how many minutes in advance Donna will remind you before events or deadlines."
          />
        </div>
        ...
        <div className="card-surface relative">
          ...
          {memory.length > 0 && (
            <div className="relative group">
              ...
              <div className="absolute top-full mt-1 w-[260px] bg-background dark:bg-background-dark text-sm text-muted-foreground p-3 rounded-lg shadow-md border border-border dark:border-border-dark opacity-0 group-hover:opacity-100 transition-opacity z-50 pointer-events-none">
                Exports all your saved memory items as a JSON file you can
                store, review, or import elsewhere.
              </div>
            </div>
          )}
        </div>
  ...
  return (
    <div className="flex items-center justify-between mt-2">
      <span className="text-sm text-foreground flex items-center gap-1">
        ...
        {help && (
          <div className="relative group">
            <FaInfoCircle className="text-blue-500 dark:text-blue-400 cursor-pointer text-sm" />
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-[240px] bg-background dark:bg-background-dark text-sm text-muted-foreground p-3 rounded-lg shadow-md border border-border dark:border-border-dark opacity-0 group-hover:opacity-100 transition-opacity z-50 pointer-events-none">
              {help}
            </div>
          </div>
        )}
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        />
        <div className="w-11 h-6 bg-muted peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-500 dark:peer-focus:ring-blue-300 rounded-full peer dark:bg-gray-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 dark:after:border-gray-500 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
      </label>
    </div>
  );
}
    ...
    <div className="mt-4">
      <label className="text-sm font-medium flex items-center gap-1">
        ...
        {help && (
          <div className="relative group">
            <FaInfoCircle className="text-blue-400 cursor-pointer text-sm" />
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-[260px] bg-background dark:bg-background-dark text-sm text-muted-foreground p-3 rounded-lg shadow-md border border-border dark:border-border-dark opacity-0 group-hover:opacity-100 transition-opacity z-50 pointer-events-none">
              {help}
            </div>
          </div>
        )}
